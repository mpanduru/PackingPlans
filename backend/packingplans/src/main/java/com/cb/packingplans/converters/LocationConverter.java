...
public class LocationConverter {
    public static Location convertLocationRequestToLocation(LocationRequest locationRequest, TagService tagService) {
        Location location = new Location(locationRequest.getName(), locationRequest.getDescription(), locationRequest.getLatitude(), locationRequest.getLongitude(), locationRequest.getImageUrl());
    ...
    public static LocationResponse convertLocationToLocationResponse(Location location) {
        ...
        return new LocationResponse(location.getId(), location.getName(), location.getDescription(), location.getLatitude(), location.getLongitude(), location.getImageUrl(), tagNames);
    }
}
